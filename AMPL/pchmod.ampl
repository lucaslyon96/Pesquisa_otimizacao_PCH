...
var wjkg {1..n,1..m,1..G}
#funcao objetivo

minimize Obj: sum{g in 1..G,k in 1..m,i in 1..n,j in 1..n}  zkg[k,g] * dkij[k,i,j] * egij[g,i,j];

#restriçoes
subject to W1 : wjkg[j,k,g]=egij[g,j,j]*zkg[k,g];
subject to W2 {k in 1..m,g in 1..G,j in 1..n } : wjkg[j,k,g]<=zkg[k,g];
subject to W3 {k in 1..m,g in 1..G,j in 1..n } : wjkg[j,k,g]<=egij[g,j,j];
subject to W4 {k in 1..m,g in 1..G,j in 1..n } : wjkg[j,k,g]>=egij[g,j,j]+(zkg[k,g]-1);
...
subject to E1 {g in 1..G}: sum {j in 1..n,k in 1..m} wjkg[j,k,g]<= (sum {k in 1..m}c[k] * zkg[k,g]);
